...
from deeptrade.strategies_builtin.volume_anomaly.volume_anomaly.data import (
    _build_candidate_row,
)
from deeptrade.strategies_builtin.volume_anomaly.volume_anomaly.prompts_examples import (
    VA_TREND_FEWSHOT,
)
...
def test_few_shot_block_appended_to_system_prompt() -> None:
    from deeptrade.strategies_builtin.volume_anomaly.volume_anomaly.prompts import (
        VA_TREND_SYSTEM,
    )
